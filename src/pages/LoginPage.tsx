  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-accent-pink/8 rounded-full blur-3xl" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Sign in to continue your conversations</p>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="text-right">
              <button type="button" className="text-xs text-accent-purple hover:underline">
                Forgot password?
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-3 rounded-xl bg-dark-300 border border-white/[0.07] text-sm font-medium text-white/60 hover:text-white hover:border-white/20 transition-all">
